...
# Krentoraan on Linux: A User's Guide 🐧

Krentoraan is not officially supported on Linux by the modlist's creator, Alaxouche. However, with a few extra steps, the Wabbajack installation can be adapted to work successfully. This guide assumes you have a basic understanding of Linux and Mod Organizer 2 (MO2).
...
> **Note:** When you launch Mod Organizer 2 for the first time after the installation finishes, an error from the **Frame Gen Compatibility Checker** may appear. This is expected because the checker does not work on Linux. Simply click **OK** to dismiss the message and continue.

### 2. Configure Mod Organizer 2

Once Wabbajack has successfully completed its installation, you need to make a few specific changes inside Mod Organizer 2 (MO2) to properly launch Krentoraan.

*   In MO2, locate the executable dropdown menu (it's usually in the top right corner).
*   Change the selected launcher from the default to **Krentoraan Legacy**.
...
*   **Close the vanilla launcher window** and change the MO2 executable back to **Krentoraan Legacy**.

### 5. Enjoy Krentoraan on Linux! 🎉

You should now be able to launch Krentoraan and play it on your Linux machine. If you encounter any further issues, please refer to the **Wabbajack Discord server in the #unofficial-linux-help channel** for troubleshooting assistance.
