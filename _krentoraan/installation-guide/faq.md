...
{% include components/faq.html
  ...
  description="Quick answers about Krentoraan installs, gameplay, and updates."
  data=site.data.krentoraan_faq
%}
...
If you crash using the latest version of Krentoraan and want to report it, here is where you can find the newest generated crash log.
...
You can copy the loadorder.txt document from your profiles folder within the Krentoraan installation to save a copy of the load order. Make sure the copy is saved outside of Krentoraan so it is not deleted in the update.
<p align="center">
