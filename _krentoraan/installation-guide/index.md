...
permalink: /krentoraan/installation-guide/
nav_order: 1
has_children: true
...
This modlist is focused on clean visuals and balanced gameplay.
...
This modlist is based on my personal preferences. It improves the vanilla game to make it look and feel better. Keep in mind that the list is more like a vanilla rework focused on clean visuals and balanced gameplay. Krentoraan is the name of a location from the lore of Skyrim.
